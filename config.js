...
global.sudo = process.env.SUDO || "2347048595483";
global.owner = process.env.OWNER_NUMBER || "2347048595483";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝐅𝐈𝐋𝐄-𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃-𝐁𝐘-Franklyn2😍",
  author: process.env.PACK_AUTHER || "WASO",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "FRANKLYN BOT",
  ownername: process.env.OWNER_NAME || "WASI",
  errorChat: process.env.ERROR_CHAT || "2347048595483",
